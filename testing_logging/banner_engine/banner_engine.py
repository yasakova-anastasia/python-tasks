...
class EpsilonGreedyBannerEngine:
    ...
    def __init__(self, banner_storage: BannerStorage, random_banner_probability: float):
        ...
        self._show_count = 0
        self._total_cost = sum([value._stat.clicks * value.cost
                                for value in banner_storage._banner_dict.values()])
    ...
    def show_banner(self) -> str:
        ...
        """
        if self._epsilon and \
                (self._epsilon == 1.0 or random.random() > self._epsilon):
